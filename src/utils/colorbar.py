...
qw1000_levels = [0, 0.025, 0.05, 0.075, .1, .15, .2, .3, .4, .5, .6, .7, .8, .9, 1.0, 1.2, 1.5, 1.7, 2]

discrete_qw1000_cmap = mcolors.ListedColormap(qw1000_colorlist)
prec_norm = mcolors.BoundaryNorm(qw1000_levels, ncolors=discrete_qw1000_cmap.N, clip=True)
