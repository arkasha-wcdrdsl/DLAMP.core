...
class DataType(Enum):
    ...
    def __new__(cls, description: str, code: str, nc_key: str) -> "DataType":
        obj = cast("DataType", object.__new__(cls))
...
class Level(Enum):
    ...
    def __new__(cls, description: str, code: str, nc_key: str) -> "Level":
        obj = cast("Level", object.__new__(cls))
        obj._value_ = description
        obj.code = code
        obj.nc_key = nc_key
        return obj
